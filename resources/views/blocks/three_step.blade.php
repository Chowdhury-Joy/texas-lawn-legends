...
<section id="about" class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-20">
        <h2 data-field="heading" data-gjs-type="text" class="mx-auto max-w-3xl text-center text-4xl font-black uppercase leading-tight tracking-tight text-slate-900 sm:text-5xl">
        ...
        <div class="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-3">
            @foreach ($processSteps as $index => $step)
                <div class="box-brutal p-8">
                    ...
                    <h3 data-field="steps.{{ $index }}.title" data-gjs-type="text" class="mt-4 text-xl font-black uppercase tracking-tight text-slate-900">
