...
<section class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-20">
        ...
        <div class="mt-14 grid grid-cols-1 gap-8 tab:grid-cols-2 lg:grid-cols-3">
            @foreach ($processSteps as $index => $step)
                <div class="box-brutal p-8 mr-[8px] lg:mr-0">
                    ...
                    <h3 data-field="steps.{{ $index }}.title" data-gjs-type="text" class="mt-4 text-2xl font-medium tracking-tighter text-slate-900">
