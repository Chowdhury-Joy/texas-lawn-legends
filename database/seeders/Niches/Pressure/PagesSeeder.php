    ...
    private function seedServicesPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'Our Services',
                'is_published' => true,
                'seo_title' => 'Pressure Washing Services — ClearPath Wash',
                'seo_description' => 'Driveway, siding, and patio washes from ClearPath Wash in Houston.',
                'blocks' => array_merge(
                    $this->block('rich_text', [
                        'heading' => 'Pressure washing, systematized.',
                        'body' => '<p>Projects for one-time washes and restorations. Maintain for recurring plans. Same transparent quote funnel either way.</p>',
                    ]),
                    $this->block('service_matrix', [
                        'create_suite_heading' => 'Projects — One-time washes & restorations',
                        'care_suite_heading' => 'Maintain — Recurring wash plans',
                    ]),
                    $this->block('cta_banner', [
                        'heading' => 'Get a wash quote',
                        'subheading' => 'Transparent pricing in under two minutes.',
                        'button_label' => 'Get Your Wash Quote',
                    ]),
                ),
            ],
        );
    ...
    private function seedPortfolioPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'Portfolio',
                'is_published' => true,
                'seo_title' => 'Wash Reviews — ClearPath Wash',
                'seo_description' => 'Houston property owners share ClearPath Wash results.',
                'blocks' => array_merge(
                    $this->block('neighborhood_proof', [
                        'heading' => 'Proof across Houston',
                        'subheading' => 'Filter by service area to see nearby reviews.',
                    ]),
                    $this->block('cta_banner', [
                        'heading' => 'Your property could be next',
                        'subheading' => 'Book a wash and track it in your dashboard.',
                        'button_label' => 'Get Your Wash Quote',
                    ]),
                ),
            ],
    ...
    private function seedAboutPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'About Us',
                'is_published' => true,
                'seo_title' => 'About ClearPath Wash',
                'seo_description' => 'Houston pressure washing with transparent pricing and insured crews.',
                'blocks' => array_merge(
                    $this->block('about', [
                        'eyebrow' => 'Our Story',
                        'heading' => 'Clean surfaces. Clear process.',
                        'body' => 'ClearPath Wash is a demo showcase brand — built to show how the same product shells a pressure washing business with Projects and Maintain suites.',
                        'stats' => [
                            ['value' => '2019', 'label' => 'Established'],
                            ['value' => '5+', 'label' => 'Houston Areas'],
