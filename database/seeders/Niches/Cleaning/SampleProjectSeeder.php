...
class SampleProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->seedDemoOps($project, $lead, [
            ...
            'labor_rate' => 28.00,
            'material_share' => 0.08,
            'funnel_service_type' => 'Move-In Deep Clean',
            'funnel_neighborhoods' => ['Hyde Park', 'Mueller', 'Crestview', 'Allandale', 'Rosedale', 'Cherrywood', 'East Austin', 'Travis Heights', 'Zilker', 'Barton Hills'],
        ]);
    }
}
