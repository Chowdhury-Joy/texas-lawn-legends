    ...
    private function seedServicesPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'Our Services',
                'is_published' => true,
                'seo_title' => 'Cleaning Services — BrightSide Cleaning',
                'seo_description' => 'Deep cleans, recurring plans, and office refresh from BrightSide Cleaning in Austin.',
                'blocks' => array_merge(
                    $this->block('rich_text', [
                        'heading' => 'Cleaning, systematized.',
                        'body' => '<p>Projects for deep and special jobs. Maintain for recurring plans. Same transparent quote funnel either way.</p>',
                    ]),
                    $this->block('service_matrix', [
                        'create_suite_heading' => 'Projects — Deep cleans & special jobs',
                        'care_suite_heading' => 'Maintain — Recurring plans',
                    ]),
                    $this->block('cta_banner', [
                        'heading' => 'Get a clean quote',
                        'subheading' => 'Transparent pricing in under two minutes.',
                        'button_label' => 'Get Your Clean Quote',
                    ]),
                ),
            ],
        );
    ...
    private function seedPortfolioPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'Portfolio',
                'is_published' => true,
                'seo_title' => 'Cleaning Reviews — BrightSide Cleaning',
                'seo_description' => 'Austin homeowners share BrightSide Cleaning results.',
                'blocks' => array_merge(
                    $this->block('neighborhood_proof', [
                        'heading' => 'Proof across Austin',
                        'subheading' => 'Filter by service area to see nearby reviews.',
                    ]),
                    $this->block('cta_banner', [
                        'heading' => 'Your home could be next',
                        'subheading' => 'Book a first clean and track it in your dashboard.',
                        'button_label' => 'Get Your Clean Quote',
                    ]),
                ),
            ],
    ...
    private function seedAboutPage(): void
    {
        Page::query()->updateOrCreate(
            ...
            [
                'title' => 'About Us',
                'is_published' => true,
                'seo_title' => 'About BrightSide Cleaning',
                'seo_description' => 'Austin cleaning teams with transparent pricing and vetted crews.',
                'blocks' => array_merge(
                    $this->block('about', [
                        'eyebrow' => 'Our Story',
                        'heading' => 'Bright homes. Clear process.',
                        'body' => 'BrightSide Cleaning is a demo showcase brand — built to show how the same product shells a cleaning business with Projects and Maintain suites.',
                        'stats' => [
                            ['value' => '2021', 'label' => 'Established'],
                            ['value' => '5+', 'label' => 'Austin Areas'],
                            ['value' => '4.9★', 'label' => 'Avg. Rating'],
                        ],
                    ]),
                    $this->block('cta_banner', [
                        'heading' => 'Ready for a brighter space?',
                        'button_label' => 'Get Your Clean Quote',
                    ]),
                ),
            ],
